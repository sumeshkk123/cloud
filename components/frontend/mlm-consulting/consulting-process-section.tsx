...
import type { ConsultingStep } from "./types";

interface ConsultingProcessSectionProps {
  badge?: string;
  heading: string;
  description?: string;
...
export function ConsultingProcessSection({ badge, heading, description, steps }: ConsultingProcessSectionProps) {
