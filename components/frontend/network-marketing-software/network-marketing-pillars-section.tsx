...
interface NetworkMarketingPillarsSectionProps {
  locale: Locale;
}

export function NetworkMarketingPillarsSection({ locale }: NetworkMarketingPillarsSectionProps) {
  const content = getNetworkMarketingSoftwareContent(locale).pillars;
