...
export function VideoShowcaseSection({
    ...
    return (
        <Section variant="default" padding="lg" className="relative isolate overflow-visible px-14 !pb-1 bg-background" containerClassName="relative z-10">
            ...
            >
                ...
                <div className="relative z-10 py-16 md:py-8">
