...
interface DirectSellingBenefitsSectionProps {
  locale: Locale;
}

export function DirectSellingBenefitsSection({ locale }: DirectSellingBenefitsSectionProps) {
  const content = getDirectSellingSoftwareContent(locale).benefits;
