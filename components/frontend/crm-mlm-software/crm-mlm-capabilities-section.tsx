...
interface CrmMlmCapabilitiesSectionProps {
  locale: Locale;
}

export function CrmMlmCapabilitiesSection({ locale }: CrmMlmCapabilitiesSectionProps) {
  const c = getCrmMlmSoftwareContent(locale).capabilities;
