...
import type { MigrationIntro as MigrationIntroType, MigrationIntroFeature } from "./types";

interface MigrationIntroProps {
  intro: MigrationIntroType;
  features: MigrationIntroFeature[];
}

export function MigrationIntro({ intro, features }: MigrationIntroProps) {
  return (
    <Section variant="default" padding="lg" className="bg-muted/30 dark:bg-muted/10">
      ...
      <div className="container space-y-14 relative">
        ...
        {/* Feature cards – same grid as services intro */}
        {features.length > 0 && (
