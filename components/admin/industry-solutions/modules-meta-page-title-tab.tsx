...
export function ModulesMetaPageTitleTab() {
  ...
  const loadAllData = async () => {
    ...
    try {
      ...
      // Load data for all module pages
  ...
  const loadModulePages = async () => {
    try {
      ...
      // Add main module page
      allPages.push({ value: MODULE_PAGE_PREFIX, label: 'MLM Software Modules' });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-semibold">Module Meta Details & Page Titles</h2>
        <Button
          variant="primary"
          onClick={() => {
            setIsFormOpen(true);
