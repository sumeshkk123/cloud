...
interface IntegrationsMetaPageTitleFormProps {
    initialPage?: string;
    initialLocale?: string;
    integrationPages?: Array<{ value: string; label: string }>;
    onClose?: () => void;
    onSave?: () => void;
...
export function IntegrationsMetaPageTitleForm({
    initialPage,
    initialLocale = 'en',
    integrationPages = [],
    onClose,
    ...
    return (
        <form
            id="integrations-meta-page-title-form"
            onSubmit={(e) => {
                e.preventDefault();
                handleSave();
            }}
