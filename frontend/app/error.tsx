...
import { Home, RefreshCw, AlertCircle, Sparkles } from "lucide-react";
      ...
      <div className="container relative flex min-h-screen flex-col items-center justify-center py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <SectionTitle
            ...
            description="We encountered an unexpected error. Our team has been notified and is working to fix the issue. Please try again in a few moments."
            centered={true}
            maxWidth="2xl"
          ...
          <div className="mt-12 rounded-2xl border border-border/60 bg-card/50 p-6 backdrop-blur-sm">
            <h3 className="mb-4 text-lg font-semibold text-foreground">Need Help?</h3>
            <p className="mb-4 text-sm text-muted-foreground">
              If this problem persists, please contact our support team.
            </p>
            <div className="flex flex-wrap justify-center gap-3">
              <Button asChild variant="ghost" size="sm">
                <Link href={`/${defaultLocale}/contact`}>Contact Support</Link>
              </Button>
              <Button asChild variant="ghost" size="sm">
                <Link href={`/${defaultLocale}/support`}>Support Center</Link>
              </Button>
            </div>
          </div>
        </div>
