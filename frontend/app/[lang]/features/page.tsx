...
export async function generateMetadata({
  ...
  const title = "MLM Software Features | Cloud MLM Software";
  const description =
    "Explore AI, core, performance, security, and unique capabilities of Cloud MLM Software, plus detailed FAQs.";

  return {
    title,
    description,
    alternates: {
      canonical: buildLocalizedPath("/features", locale)
    },
    openGraph: {
      title,
      description
