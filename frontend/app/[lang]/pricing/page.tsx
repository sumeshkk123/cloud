...
import PricingAccessSection from "@/components/pricing/pricing-access-section";
...
export async function generateMetadata({
  ...
  const title = "Pricing";
  const description =
    "Explore transparent Cloud MLM Software pricing tiers, add-ons, and ownership benefits tailored to your network marketing strategy.";

  return {
    title,
    description,
    alternates: {
      canonical: buildLocalizedPath("/pricing", locale)
    },
    openGraph: {
      title,
      description
