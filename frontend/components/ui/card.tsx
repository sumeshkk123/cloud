...
>(({ className, icon: Icon, ...props }, ref) => (
    <div className="relative inline-flex">
        ...
        <span
            ref={ref}
            className={cn(
                "relative flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/10 text-primary transition-all duration-500 group-hover:scale-110 group-hover:bg-primary/20 group-hover:rotate-3",
                className
            )}
            {...props}
        >
