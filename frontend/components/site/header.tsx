...
export function SiteHeader({
  ...
  return (
    <header ref={headerRef} className="sticky top-0 z-50 w-full bg-background shadow-sm">
      ...
      <div className="flex h-16 w-full items-center justify-between border-b border-border/40 bg-background/95 px-4 backdrop-blur xl:px-6">
...
function HeaderLink({ item, locale }: { item: NavItem; locale: SupportedLocale }) {
  ...
  const linkClasses = cn(
    "inline-flex items-center rounded-full px-3 py-2 text-sm font-medium text-muted-foreground transition",
