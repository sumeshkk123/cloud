    ...
    return (
        <>
            <div
                ...
                style={{ zIndex: 9999 }}
            >
                <div className="w-full backdrop-blur-sm border-b border-border/50" style={{ zIndex: 9999 }}>
                    <div className=" mx-auto">
                        <div className={`${isScrolled ? 'flex h-20' : 'flex h-20'} w-full items-center justify-between bg-white dark:bg-background/90 px-4 lg:px-8 xl:px-6 relative`} style={{ zIndex: 9999 }}>
