...
export const metadata = {
  title: "404 - Page Not Found | Cloud MLM Software",
          ...
          <div className="mt-12 rounded-2xl border border-border/60 bg-card/50 p-6 backdrop-blur-sm">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Button asChild variant="ghost" size="sm">
                <Link href={`/${defaultLocale}/features`}>Features</Link>
              </Button>
              <Button asChild variant="ghost" size="sm">
                <Link href={`/${defaultLocale}/pricing`}>Pricing</Link>
              </Button>
              <Button asChild variant="ghost" size="sm">
                <Link href={`/${defaultLocale}/contact`}>Contact</Link>
              </Button>
              <Button asChild variant="ghost" size="sm">
                <Link href={`/${defaultLocale}/blog`}>Blog</Link>
              </Button>
            </div>
          </div>
        </div>
