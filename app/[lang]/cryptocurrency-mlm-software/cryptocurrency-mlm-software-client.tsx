...
import { cryptocurrencyMlmContent } from "./content";

type CryptocurrencyMlmSoftwareClientProps = {
...
export function CryptocurrencyMlmSoftwareClient({
  pageTitleData,
  contactHref,
  secondaryHref,
  locale = "en",
}: CryptocurrencyMlmSoftwareClientProps) {
  const content = mergeContentWithPageTitle(
    cryptocurrencyMlmContent,
    pageTitleData
  );
  return (
    <ServiceSubpageLayout
      ...
      serviceSlug="cryptocurrency-mlm-software"
      locale={locale}
    />
  );
}
