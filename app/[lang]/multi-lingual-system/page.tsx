...
import { MultiLingualSystemClient } from "./multi-lingual-system-client";

export const dynamic = "force-dynamic";

const DEMO_URL = "https://demo.cloudmlmsoftware.com";
const MODULE_SLUG = "multi-lingual-system";
...
export default async function MultiLingualSystemPage(props: MultiLingualSystemPageProps) {
