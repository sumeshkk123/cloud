...
export function CompensationClient({
  ...
  secondaryHref,
  locale = "en",
}: CompensationClientProps) {
  const content = mergeContentWithPageTitle(compensationContent, pageTitleData);
  return (
    <ModuleSubpageLayout
      content={content}
      contactHref={contactHref}
      demoHref={secondaryHref}
      moduleSlug="compensation-module"
      locale={locale}
    />
  );
}
