...
export function EWalletClient({
  pageTitleData,
  contactHref,
  secondaryHref,
  locale = "en",
}: EWalletClientProps) {
  const content = mergeContentWithPageTitle(eWalletContent, pageTitleData);
  return (
    <ModuleSubpageLayout
      content={content}
      contactHref={contactHref}
      demoHref={secondaryHref}
      moduleSlug="e-wallet-module-for-mlm-software"
      locale={locale}
    />
  );
}
