...
export function ExamplesSection() {
  return (
    <Section padding="lg" variant="gradient" containerClassName="space-y-12">
      <SectionTitle
        badge="Examples"
        heading="Interactive Auto Fill plan examples"
        description="Stress-test scenarios before launch and give leadership instant insight into queue velocity and cycle outcomes."
        centered={false}
        maxWidth="3xl"
      />
