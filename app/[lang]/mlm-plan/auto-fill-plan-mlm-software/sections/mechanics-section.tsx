...
export function MechanicsSection() {
  return (
    <Section padding="md" variant="gradient" containerClassName="space-y-12">
      <SectionTitle
        heading="How the Auto Fill mechanics operate"
        description="Map every placement rule, queue health cue, and payout control so leaders and compliance teams stay in sync from day one."
        centered={false}
        maxWidth="3xl"
      />
