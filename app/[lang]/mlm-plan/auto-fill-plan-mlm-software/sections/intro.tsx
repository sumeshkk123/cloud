...
const AUTOFILL_ANIMATE_SRC = "/images/mlm-plans/autofill_animate.gif";
...
export function WhatIsSection() {
  return (
    <Section padding="lg" variant="primary" containerClassName="space-y-12">
      ...
      <SectionTitle
        badge="Overview"
        heading="What is Auto Fill MLM Plan?"
        centered={false}
        maxWidth="3xl"
      />
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,420px)] lg:items-center">
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="relative h-[340px] w-full max-w-[420px] overflow-hidden rounded-2xl border border-border/60 bg-black/5 dark:bg-white/5">
            <Image
              src={AUTOFILL_ANIMATE_SRC}
              alt="Auto Fill MLM plan – auto-filling network animation"
              fill
