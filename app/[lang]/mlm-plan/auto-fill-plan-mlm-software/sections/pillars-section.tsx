...
export function PillarsSection() {
  return (
    <Section padding="lg" variant="gradient" containerClassName="space-y-12">
      <SectionTitle
        badge="Foundations"
        heading="Understand the Auto Fill plan foundations"
        description="Build alignment between product, compliance, and field leadership with transparent placement and queue mechanics."
        centered={false}
        maxWidth="3xl"
      />
