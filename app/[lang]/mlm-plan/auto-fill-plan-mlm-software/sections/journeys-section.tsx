...
export function JourneysSection() {
  return (
    <Section padding="lg" variant="gradient" containerClassName="space-y-12">
      <SectionTitle
        badge="Journey"
        heading="Member journey clarity from enrolment to cycle completion"
        description="Everyone involved sees where a promoter sits in the queue, what unlocks the next milestone, and how Cloud MLM Software supports the transition."
        centered={false}
        maxWidth="3xl"
      />
