...
import { paymentGatewayIntegrationContent } from "./content";

type PaymentGatewayIntegrationClientProps = {
...
export function PaymentGatewayIntegrationClient({
  pageTitleData,
  contactHref,
  secondaryHref,
}: PaymentGatewayIntegrationClientProps) {
