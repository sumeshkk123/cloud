import { CircleDollarSign, Wallet, LineChart, ShieldCheck } from "lucide-react";
    ...
    cards: [
      {
        ...
        title: "Crypto payouts & multi-currency",
        description:
          "Support Bitcoin and major cryptocurrencies for commissions and bonuses. Run fiat and crypto in one platform with e-wallets and multi-currency dashboards for distributors.",
      },
      {
        icon: Wallet,
        title: "Compensation & genealogy integration",
        description:
          "Same compensation engine and genealogy; add crypto as a payout option without changing plan logic. Balances and payouts stay in sync across your network.",
      },
      {
        icon: ShieldCheck,
        title: "Compliance & audit-ready reporting",
        description:
          "Audit trails, KYC integration, and reporting for both fiat and crypto. Stay compliant across regions with configuration per jurisdiction.",
      },
    ],
  },
  benefitsSection: {
