...
export function TicketSystemClient({ pageTitleData, contactHref, secondaryHref }: Props) {
  return <ModuleSubpageLayout content={merge(ticketSystemContent, pageTitleData)} contactHref={contactHref} demoHref={secondaryHref} />;
}
