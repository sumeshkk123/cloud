...
import { ECommerceIntegrationClient } from "./e-commerce-integration-client";
...
export default async function ECommerceIntegrationPage(
  props: ECommerceIntegrationPageProps
) {
