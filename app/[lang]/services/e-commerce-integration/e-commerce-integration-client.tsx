...
import { eCommerceIntegrationContent } from "./content";

type ECommerceIntegrationClientProps = {
...
export function ECommerceIntegrationClient({
  pageTitleData,
  contactHref,
  secondaryHref,
  locale = "en",
}: ECommerceIntegrationClientProps) {
  const content = mergeContentWithPageTitle(eCommerceIntegrationContent, pageTitleData);
  return (
    <ServiceSubpageLayout
      ...
      serviceSlug="e-commerce-integration"
      locale={locale}
    />
  );
}
