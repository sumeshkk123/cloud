...
import { opencartDevelopmentContent } from "./content";

type OpencartDevelopmentClientProps = {
...
export function OpencartDevelopmentClient({
  pageTitleData,
  contactHref,
  secondaryHref,
  locale = "en",
}: OpencartDevelopmentClientProps) {
  const content = mergeContentWithPageTitle(opencartDevelopmentContent, pageTitleData);
  return (
    <ServiceSubpageLayout
      ...
      serviceSlug="opencart-development"
      locale={locale}
    />
  );
}
