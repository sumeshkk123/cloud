...
export function EVoucherClient({ pageTitleData, contactHref, secondaryHref }: Props) {
  return <ModuleSubpageLayout content={merge(eVoucherContent, pageTitleData)} contactHref={contactHref} demoHref={secondaryHref} />;
}
